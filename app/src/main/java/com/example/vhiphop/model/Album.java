...
/*
 *作者：created by 影子 on 2020/4/26 15:16
...
public class Album implements Parcelable {
    ...
    private String albumDesc;//专辑描述 故事发生
    private Site site;//网站
    private String tip;//提示
    private boolean isCompleted;//专辑是否额更新完毕 追播剧更新56集 播了50集
    private String letvStyle;//乐视特殊字段
    private Context context;
    /* 自动生成get set方法 --> 右键 -->Generate --> Getter and setter */
    ...
    @Override
    public void writeToParcel(Parcel parcel, int in) {//写
